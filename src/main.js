...
k.loadSprite("sonic", "graphics/sonic.png", {
  ...
  anims: {
    run: { from: 0, to: 7, loop: true, speed: 10*2.5 }, // СКРОРОСТЬ СМЕНЫ АНИМАЦИИ БЕГА и СКОРОСТЬ САМОГО БЕГА ыыы
    jump: { from: 8, to: 15, loop: true, speed: 5*2.5 }, // СКОРОСТЬ СМЕНЫ АНИМАЦИИ ПРЫЖКА и СКОРОСТЬ САМОЙ ПРЫЖКИ ыыы
  },
});
